...
var prototypeAccessors = { vm: { configurable: true },available: { configurable: true },language: { configurable: true },translations: { configurable: true } };
...
prototypeAccessors.translations.get = function () { return looseClone(this._vm.translations) };
...
VueGettext.prototype.getTranslation = function getTranslation (msgid, n, context, defaultPlural, language) {
  ...
  // https://www.gnu.org/software/gettext/manual/html_node/Language-Codes.html#Language-Codes
  var translations = this.translations[language] || this.translations[language.split('_')[0]];
